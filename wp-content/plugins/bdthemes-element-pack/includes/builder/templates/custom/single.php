...
/**
 * Template for displaying single custom post type items
 *
 * This template can be overridden by copying it to yourtheme/bdthemes-element-pack/custom/{post_type}/single.php
 *
