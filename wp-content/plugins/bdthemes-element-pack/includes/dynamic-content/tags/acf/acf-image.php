...
class ElementPack_Dynamic_Tag_ACF_Image extends \Elementor\Core\DynamicTags\Data_Tag
{
    ...
    {
        return 'element-pack-acf-image';
    }

    public function get_title(): string
    {
        return esc_html__('Image', 'bdthemes-element-pack');
    }
