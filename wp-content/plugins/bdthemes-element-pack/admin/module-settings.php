...
class ModuleService {
	...
	public static function get_widget_settings($callable) {
		...
		$settings_fields = [
			...
			'element_pack_elementor_extend' => [
				...
				[
					...
					'video_url'    => 'https://youtu.be/5aJvWL3Xn-0?si=iUiGH11iiofMPJvb',
				],
				[
					'name'        => 'image-parallax',
		...
		$settings_fields['element_pack_third_party_widget'][] = [
			...
			'video_url'   => 'https://youtu.be/U53H31MCiy4?si=OYOXb2ht-8_4a3G1',
		];
		...
		if (ModuleService::_is_plugin_installed('easy-digital-downloads', 'easy-digital-downloads/easy-digital-downloads.php') === true && is_plugin_active('easy-digital-downloads-pro/easy-digital-downloads.php') !== true) {
			...
			$settings_fields['element_pack_third_party_widget'][] = [
				...
				'video_url'   => 'https://youtu.be/IKpTcUQk3Uk?si=mCG5liqV0jzKheXj',
			];
		...
		$settings_fields['element_pack_third_party_widget'][] = [
			...
			'paid'         => 'https://bdthemes.com/secure/plugins/bdthemes-faq.zip?key=849686abd67b099b7cdbc7cfeff49ed8',
			'widget_type'  => 'pro',
			'content_type' => 'post',
