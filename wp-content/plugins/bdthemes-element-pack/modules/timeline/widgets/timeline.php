	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[ 
				...
				'placeholder' => '1px',
				'default'     => '1px',
				'selector'    => '{{WRAPPER}} .bdt-timeline.bdt-timeline-skin-default .bdt-timeline-item-main-wrapper .bdt-timeline-icon span',
			]
		);
			...
			<?php else : ?>
				<span>
					<?php if ( $settings['icon_show'] ) : ?>
						<i class="ep-icon-post" aria-hidden="true"></i>
					<?php endif; ?>
				</span>
			<?php endif; ?>
		</div>
					...
					while ( $wp_query->have_posts() ) :
						...
						<div
							...
							<div class="bdt-timeline-item-main-wrapper">
								<?php if ($bdt_count < $wp_query->post_count) : // Don't show line for the last item ?>
			...
			<div class="bdt-grid bdt-grid-collapse" bdt-grid>
				...
				foreach ( $timeline_items as $item ) :
					...
					<div
						...
						<div class="bdt-timeline-item-main-wrapper">
							<?php if ($bdt_count < count($timeline_items)) : // Don't show line for the last item ?>
							<div class="bdt-timeline-line">
