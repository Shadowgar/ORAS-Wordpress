...
?>
		<div class="bdt-protected-content-message">
			...
			<?php
				...
				echo Element_Pack_Loader::elementor()->frontend->get_builder_content_for_display($settings['warning_message_template']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo wp_kses( element_pack_template_edit_link($settings['warning_message_template']), element_pack_allow_tags( 'text' ) );
			} elseif ('anywhere' == $settings['warning_message_type'] and !empty($settings['warning_message_anywhere_template'])) {
				// PHPCS - should not be escaped.
				echo Element_Pack_Loader::elementor()->frontend->get_builder_content_for_display($settings['warning_message_anywhere_template']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo wp_kses( element_pack_template_edit_link($settings['warning_message_anywhere_template']), element_pack_allow_tags( 'text' ) );
			}
			?>
		</div>
	<?php
		...
		<div class="protected-content">
			...
			if ('custom_content' == $settings['protected_content_type'] and !empty($settings['protected_custom_content'])) { ?>
				<div class="bdt-protected-content-message">
					...
					echo $this->parse_text_editor($settings['protected_custom_content']);
					?>
				</div>
			<?php
			} elseif ('elementor' == $settings['protected_content_type'] and !empty($settings['protected_elementor_template'])) {
				// PHPCS - should not be escaped.
				echo Element_Pack_Loader::elementor()->frontend->get_builder_content_for_display($settings['protected_elementor_template']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo wp_kses( element_pack_template_edit_link($settings['protected_elementor_template']), element_pack_allow_tags( 'text' ) );
			} elseif ('anywhere' == $settings['protected_content_type'] and !empty($settings['protected_anywhere_template'])) {
				// PHPCS - should not be escaped.
				echo Element_Pack_Loader::elementor()->frontend->get_builder_content_for_display($settings['protected_anywhere_template']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo wp_kses( element_pack_template_edit_link($settings['protected_anywhere_template']), element_pack_allow_tags( 'text' ) );
			}
			?>
		</div>
	<?php
