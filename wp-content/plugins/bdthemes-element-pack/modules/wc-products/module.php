...
class Module extends Element_Pack_Module_Base {
	...
	public function callback_ajax_loadmore_wc_products() {
		if ( ! isset( $_POST['settings']['nonce'] ) || ! wp_verify_nonce( sanitize_key( wp_unslash($_POST['settings']['nonce']) ), 'ajax-ep-wc-product-nonce' ) ) {
			exit;
		}

		$ajaxSettings = wp_unslash($_POST['settings']);
