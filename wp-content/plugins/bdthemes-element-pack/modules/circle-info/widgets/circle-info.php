    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#5f6671',
                'selectors' => [
                    '{{WRAPPER}} .bdt-ep-circle-info-title' => 'color: {{VALUE}} ',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdt-ep-circle-info-title',
            ]
        );
        $this->add_group_control(
            Group_Control_Text_Stroke::get_type(),
            [
                'name'     => 'circle_info_title_text_stroke',
                'selector' => '{{WRAPPER}} .bdt-ep-circle-info-title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#1e87f0',
                'selectors' => [
                    '{{WRAPPER}} .bdt-ep-circle-info-title:hover ' => 'color: {{VALUE}} ',
                ],
            ]
        );

        $this->add_control(
            'circle_info_title_text_stroke_hover_color',
            [
                'label'     => esc_html__('Stroke Color', 'bdthemes-element-pack'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdt-ep-circle-info-title:hover' => '-webkit-text-stroke-color: {{VALUE}}; stroke: {{VALUE}};',
                ],
            ]
        );
                    ...
                    ?>
                        ...
                        <div <?php $this->print_render_attribute_string('circle_content'); ?>>
                            ...
                            <div class="bdt-ep-circle-info-content-inner">
                                <div class="bdt-ep-circle-info-title-wrap">
                                    <<?php echo esc_attr(Utils::get_valid_html_tag($settings['title_tags'])); ?> <?php $this->print_render_attribute_string('circle_title_tags'); ?>>
                                        ...
                                        <?php if ( ! empty( $item['circle_info_title_link']['url'] ) ) : ?>
