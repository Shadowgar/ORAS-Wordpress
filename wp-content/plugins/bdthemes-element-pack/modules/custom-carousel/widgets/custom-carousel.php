				...
				'custom-carousel' => [ 
					'data-settings' => [ 
						wp_json_encode( array_filter( [ 
							...
							"spaceBetween"    => !empty($settings["space_between_mobile"]["size"]) ? (int)$settings["space_between_mobile"]["size"] : 0,
							...
							"breakpoints"     => [ 
								(int) $viewport_md => [ 
									...
									"spaceBetween"   => !empty($settings["space_between_tablet"]["size"]) ? (int)$settings["space_between_tablet"]["size"] : 0,
								...
								(int) $viewport_lg => [ 
									...
									"spaceBetween"   => !empty($settings["space_between"]["size"]) ? (int)$settings["space_between"]["size"] : 0,
