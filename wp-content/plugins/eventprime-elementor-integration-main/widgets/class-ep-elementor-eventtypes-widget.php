 ...
 * @since 1.0.0
 */
class Elementor_EP_Eventtypes_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'eventprimeelementoreventtypes';
	}
	...
	public function get_title() {
		return __( 'EventPrime Event-Types', 'eventprime-elementor-integration' );
	}
	...
	public function get_icon() {
		return 'eicon-theme-builder ep-icon-eventprime-event-type ep-eventprime-elementor-icon';
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'EventPrime Event-Types', 'eventprime-elementor-integration' ),
		...
		$this->add_control(
			'featured',
			[
				'label' => esc_html__( 'Enable Featured Event-Types', 'eventprime-elementor-integration' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'eventprime-elementor-integration' ),
				'label_off' => esc_html__( 'No', 'eventprime-elementor-integration' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'popular',
			[
				'label' => esc_html__( 'Enable Popular Event-Types', 'eventprime-elementor-integration' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'eventprime-elementor-integration' ),
				'label_off' => esc_html__( 'No', 'eventprime-elementor-integration' ),
				'return_value' => 'yes',
	...
	protected function render() {
		...
		$atts['type_box_color'][0] = isset( $settings['type_box_1_color'] ) ? $settings['type_box_1_color'] : '';
		$atts['type_box_color'][1] = isset( $settings['type_box_2_color'] ) ? $settings['type_box_2_color'] : '';
		$atts['type_box_color'][2] = isset( $settings['type_box_3_color'] ) ? $settings['type_box_3_color'] : '';
		$atts['type_box_color'][3] = isset( $settings['type_box_4_color'] ) ? $settings['type_box_4_color'] : '';
        ...
        echo $event_controller->load_event_types($atts);
