 ...
 * @since 1.0.0
 */
class Elementor_EP_Performers_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'eventprimeelementorperformers';
	}
	...
	public function get_title() {
		return __( 'EventPrime Event Performers', 'eventprime-elementor-integration' );
	}
	...
	public function get_icon() {
		return 'eicon-person ep-icon-eventprime-performers ep-eventprime-elementor-icon';
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'EventPrime Event Performers', 'eventprime-elementor-integration' ),
		...
		$this->add_control(
			'featured',
			[
				'label' => esc_html__( 'Enable Featured Performers', 'eventprime-elementor-integration' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'eventprime-elementor-integration' ),
				'label_off' => esc_html__( 'No', 'eventprime-elementor-integration' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'popular',
			[
				'label' => esc_html__( 'Enable Popular Performers', 'eventprime-elementor-integration' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'eventprime-elementor-integration' ),
				'label_off' => esc_html__( 'No', 'eventprime-elementor-integration' ),
				'return_value' => 'yes',
	...
	protected function render() {
		...
		$atts['performer_box_color'][0] = ( isset( $settings['performer_box_1_color'] ) && ! empty( $settings['performer_box_1_color'] ) ) ? $settings['performer_box_1_color'] : '';
		$atts['performer_box_color'][1] = ( isset( $settings['performer_box_2_color'] ) && ! empty( $settings['performer_box_1_color'] ) ) ? $settings['performer_box_2_color'] : '';
		$atts['performer_box_color'][2] = ( isset( $settings['performer_box_3_color'] ) && ! empty( $settings['performer_box_1_color'] ) ) ? $settings['performer_box_3_color'] : '';
		$atts['performer_box_color'][3] = ( isset( $settings['performer_box_4_color'] ) && ! empty( $settings['performer_box_1_color'] ) ) ? $settings['performer_box_4_color'] : '';
        ...
        echo $event_controller->load_performers($atts);
