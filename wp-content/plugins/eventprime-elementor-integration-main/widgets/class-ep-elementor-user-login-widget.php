 ...
 * @since 1.0.0
 */
class Elementor_EP_User_Login_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'eventprimeelementoruserlogin';
	}
	...
	public function get_title() {
		return __( 'EventPrime User Login', 'eventprime-elementor-integration' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'EventPrime User Login', 'eventprime-elementor-integration' ),
	...
	protected function render() {
		...
		$atts = array();
                ...
                echo $event_controller->load_login($atts);
	}
