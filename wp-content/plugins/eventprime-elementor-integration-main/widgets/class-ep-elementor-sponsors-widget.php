 ...
 * @since 1.0.0
 */
class Elementor_EP_Sponsors_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'eventprimeelementorsponsors';
	}
	...
	public function get_title() {
		return __( 'EventPrime Event Sponsors', 'eventprime-elementor-integration' );
	}
	...
	public function get_icon() {
		return 'eicon-person ep-icon-eventprime-sponsors ep-eventprime-elementor-icon';
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'EventPrime Event Sponsors', 'eventprime-elementor-integration' ),
		...
		$this->add_control(
			'featured',
			[
				'label' => esc_html__( 'Enable Featured Sponsors', 'eventprime-elementor-integration' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'eventprime-elementor-integration' ),
				'label_off' => esc_html__( 'No', 'eventprime-elementor-integration' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'popular',
			[
				'label' => esc_html__( 'Enable Popular Sponsors', 'eventprime-elementor-integration' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'eventprime-elementor-integration' ),
				'label_off' => esc_html__( 'No', 'eventprime-elementor-integration' ),
				'return_value' => 'yes',
	...
	protected function render() {
		...
		$atts['sponsor_box_color'][0] = ( isset( $settings['sponsor_box_1_color'] ) && ! empty( $settings['sponsor_box_1_color'] ) ) ? $settings['sponsor_box_1_color'] : '';
		$atts['sponsor_box_color'][1] = ( isset( $settings['sponsor_box_2_color'] ) && ! empty( $settings['sponsor_box_1_color'] ) ) ? $settings['sponsor_box_2_color'] : '';
		$atts['sponsor_box_color'][2] = ( isset( $settings['sponsor_box_3_color'] ) && ! empty( $settings['sponsor_box_1_color'] ) ) ? $settings['sponsor_box_3_color'] : '';
		$atts['sponsor_box_color'][3] = ( isset( $settings['sponsor_box_4_color'] ) && ! empty( $settings['sponsor_box_1_color'] ) ) ? $settings['sponsor_box_4_color'] : '';

		$atts['limit']         = isset( $settings['limit'] ) ? $settings['limit'] : EM_PAGINATION_LIMIT; 
        ...
        if(class_exists('Eventprime_Event_Sponsor_Public')){
		$sponsors = new Eventprime_Event_Sponsor_Public('eventprime-elementor-integration', '1.0.0');
		echo $sponsors->load_sponsors( $atts );
        }
