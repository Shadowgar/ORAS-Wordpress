 ...
 * @since 1.0.0
 */
class Elementor_EP_Venues_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'eventprimeelementorvenues';
	}
	...
	public function get_title() {
		return __( 'EventPrime Venues', 'eventprime-elementor-integration' );
	}
	...
	public function get_icon() {
		return 'eicon-google-maps ep-icon-eventprime-venues ep-eventprime-elementor-icon';
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'EventPrime Venues', 'eventprime-elementor-integration' ),
		...
		$this->add_control(
			'featured',
			[
				'label' => esc_html__( 'Enable Featured Venues', 'eventprime-elementor-integration' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'eventprime-elementor-integration' ),
				'label_off' => esc_html__( 'No', 'eventprime-elementor-integration' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'popular',
			[
				'label' => esc_html__( 'Enable Popular Venues', 'eventprime-elementor-integration' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'eventprime-elementor-integration' ),
				'label_off' => esc_html__( 'No', 'eventprime-elementor-integration' ),
				'return_value' => 'yes',
	...
	protected function render() {
		...
		$atts['venue_box_color'][0] = isset( $settings['venue_box_1_color'] ) ? $settings['venue_box_1_color'] : '';
		$atts['venue_box_color'][1] = isset( $settings['venue_box_2_color'] ) ? $settings['venue_box_2_color'] : '';
		$atts['venue_box_color'][2] = isset( $settings['venue_box_3_color'] ) ? $settings['venue_box_3_color'] : '';
		$atts['venue_box_color'][3] = isset( $settings['venue_box_4_color'] ) ? $settings['venue_box_4_color'] : '';
		...
		$event_controller = new Eventprime_Event_Calendar_Management_Public('eventprime-elementor-integration', '1.0.0');
                echo $event_controller->load_venues($atts);
