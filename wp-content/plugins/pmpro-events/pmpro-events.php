...
function pmpro_events_plugin_init() {
	...
	// EventPrime (https://wordpress.org/plugins/eventprime-event-calendar-management/event-prime.php/)
    if ( class_exists( 'Eventprime_Event_Calendar_Management' ) ) {
	    require_once( $path . '/modules/event-prime.php' );
		error_log('PMPro Events Prime module loaded'); // <-- Debug
 }
}
