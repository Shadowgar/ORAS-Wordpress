...
if ( ! class_exists( 'bkap_booking_box_class' ) ) {
	...
	class bkap_booking_box_class {
		...
		public static function bkap_meta_box() {
			...
			do_action( 'bkap_before_booking_meta_box', $duplicate_of, $post );
			...
			if ( ( isset( $post->filter ) && 'raw' == $post->filter ) && '' == $booking_settings ) {
				...
				$individual_booking_settings = apply_filters( 'bkap_individual_booking_settings', get_option( 'bkap_default_individual_booking_settings', array() ), $duplicate_of, $post );
		...
		<div id="set_weekdays" class="weekdays_flex_main" style="margin-bottom:20px;width:100%;float:left; <?php echo $display; ?>" >
			<div class="weekdays_flex_child" >
				<div class="weekdays_flex_child_1 bkap_weekdays_heading" style="max-width:27%;"><b><?php esc_html_e( 'Weekday', 'woocommerce-booking' ); ?></b></div>
				<div class="weekdays_flex_child_2 bkap_weekdays_heading" style="max-width:20%;"><b><?php esc_html_e( 'Bookable', 'woocommerce-booking' ); ?></b></div>
				...
				?>
				<div class="weekdays_flex_child_3 bkap_weekdays_heading" style="max-width:26%;<?php echo $mutiple_display; ?>"><b><?php esc_html_e( 'Maximum bookings', 'woocommerce-booking' ); ?></b></div>
		...
		static function bkap_get_specific_html( $product_id, $booking_settings, $default_booking_settings, $defaults ) {
			...
			<div class="specific_date_title" style="display:flex;width:100%;margin-top:20px;">
				<div>
				  <b><?php esc_html_e( 'Set Availability by Dates/Months', 'woocommerce-booking' ); ?></b>
				</div>
			...
			<div class="specific_date" style="<?php echo $specific_date_table; ?>">
				<table class="specific">
					...
					<tr style="padding:5px; border-top:2px solid #eee">
					   <td colspan="4" style="border-right: 0px;"><i><small><?php esc_html_e( 'Create custom ranges, holidays and more here.', 'woocommerce-booking' ); ?></small><i></td>
					   <td colspan="2" align="right" style="border-left: none;"><button type="button" class="button-primary bkap_add_new_range"><?php esc_html_e( 'Add New Range', 'woocommerce-booking' ); ?></button></td>
					</tr>
				</table>
		   </div>
			<?php
			   ...
			   <td>
				   ...
				   <td class="date_selection_textbox1" style="width:20%;">
						<div class="fake-input">
							...
							<img src="<?php echo esc_url( plugins_url( 'woocommerce-booking/assets/images/cal.gif' ) ); ?>" id="custom_checkin_cal" width="15" height="15" />
						</div>
				   </td>
				   <!-- To Custom-->
				   <td class="date_selection_textbox2">
						<div class="fake-input" >
							...
							<img src="<?php echo esc_url( plugins_url( 'woocommerce-booking/assets/images/cal.gif' ) ); ?>" id="custom_checkout_cal" width="15" height="15" />
						</div>
				   </td>
				   ...
				   <td class="date_selection_textbox3" colspan="2" style="display:none;" >
						 <div class="fake-textarea" >
							 ...
							 <img src="<?php echo esc_url( plugins_url( 'woocommerce-booking/assets/images/cal.gif' ) ); ?>" id="specific_date_multidate_cal" class="bkap_multiple_datepicker_cal_image" width="15" height="15" />
						 </div>
				   </td>
				   ...
				   <td class="date_selection_textbox6" colspan="2" style="display:none;" >
						 <div class="fake-textarea" >
							 ...
							 <img src="<?php echo esc_url( plugins_url( 'woocommerce-booking/assets/images/cal.gif' ) ); ?>" id="holiday_multidate_cal" class="bkap_multiple_datepicker_cal_image" width="15" height="15" />
						 </div>
				   </td>
			...
			if ( isset( $booking_special_prices ) && $count_special_prices > 0 ) {
				...
				foreach ( $booking_special_prices as $s_key => $s_value ) {
					...
					if ( isset( $s_value['booking_special_date'] ) && $s_value['booking_special_date'] != '' ) {
						$s_date                    = gmdate( 'j-n-Y', strtotime( $s_value['booking_special_date'] ) );
			...
			if ( isset( $booking_holiday_ranges ) && $count_holiday_ranges > 0 ) {
				for ( $bkap_range = 0; $bkap_range < $count_holiday_ranges; $bkap_range++ ) {
					...
					if ( isset( $booking_holiday_ranges[ $bkap_range ] ) ) {
						...
						$bkap_holiday_from_month     = gmdate( 'F', strtotime( $booking_holiday_ranges[ $bkap_range ]['start'] ) );
						$bkap_holiday_to_month       = gmdate( 'F', strtotime( $booking_holiday_ranges[ $bkap_range ]['end'] ) );
						$holiday_start_date_of_month = gmdate( '1-n-Y', strtotime( $booking_holiday_ranges[ $bkap_range ]['start'] ) );
						$holiday_end_date_of_month   = gmdate( 't-n-Y', strtotime( $booking_holiday_ranges[ $bkap_range ]['end'] ) );
			...
			while ( $i < count( $array_of_all_added_ranges ) ) {
				...
				switch ( $range_type ) {
					...
					case 'range_of_months':
						...
						$month_bkap_start          = gmdate( 'F', strtotime( $bkap_start ) );
						$month_bkap_end            = gmdate( 'F', strtotime( $bkap_end ) );
				  ...
				  <tr class="added_specific_date_range_row_<?php echo $i; ?> <?php echo $bkap_row_toggle; ?>" <?php echo $bkap_row_toggle_display; ?>>
					  ...
					  <td class="date_selection_textbox1" style="width:20%;<?php echo $custom_range_disaply; ?>">
						   <div class="fake-input">
							   ...
							   <img src="<?php echo esc_url( plugins_url( 'woocommerce-booking/assets/images/cal.gif' ) ); ?>" id="custom_checkin_cal_<?php echo $i; ?>" width="15" height="15" />
						   </div>
					  </td>
					  ...
					  <td class="date_selection_textbox2" style="width:20%;<?php echo $custom_range_disaply; ?>">
						   <div class="fake-input" >
							   ...
							   <img src="<?php echo esc_url( plugins_url( 'woocommerce-booking/assets/images/cal.gif' ) ); ?>" id="custom_checkout_cal_<?php echo $i; ?>" width="15" height="15" />
						   </div>
					  </td>
					  ...
					  <td class="date_selection_textbox3" colspan="2" style="<?php echo $specific_dates_disaply; ?>width:40%;" >
						   <div class="fake-textarea" >
							   ...
							   <img src="<?php echo esc_url( plugins_url( 'woocommerce-booking/assets/images/cal.gif' ) ); ?>" id="specific_date_multidate_cal_<?php echo $i; ?>" class="bkap_multiple_datepicker_cal_image" width="15" height="15" />
						   </div>
					  </td>
					  ...
					  <td class="date_selection_textbox4" style="<?php echo $range_of_months_disaply; ?>width:20%;">
					   ...
					   <td class="date_selection_textbox6" colspan="2" style="<?php echo $holidays_disaply; ?>width:40%" >
							<div class="fake-textarea" >
								...
								<img src="<?php echo esc_url( plugins_url( 'woocommerce-booking/assets/images/cal.gif' ) ); ?>" id="holiday_multidate_cal_<?php echo $i; ?>" class="bkap_multiple_datepicker_cal_image" width="15" height="15" />
							</div>
					   </td>
				...
				<div class="bkap_time_slots_pagenav">
					<span class="bkap_displaying_num">
						<span class="bkap_display_count_num">
							<?php esc_html_e( $bkap_total_time_slots_number, 'woocommerce-booking' ); ?>
						</span>
					...
					<span class="bkap_pagination_links">
						...
						<span class="bkap_paging_select">
							<label for="bkap_current_page_selector_1" class="bkap_screen_reader_text"><?php esc_html_e( 'Select Page', 'woocommerce-booking' ); ?></label>
		   ...
		   <!-- Table for adding Date/Day and time table -->
			<div class="bkap_date_timeslot_div" style="<?php echo $date_time_table; ?>">
			   ...
			   <?php do_action( 'bkap_before_time_enabled', $product_id, $booking_settings ); ?>
				...
				<div>
					<h4><?php esc_html_e( 'Set Weekdays/Dates And It\'s Timeslots :', 'woocommerce-booking' ); ?></h4>
				</div>
				...
				<table id="bkap_date_timeslot_table">
				   <?php
					...
					<tr style="padding:5px; border-top:2px solid #eee">
					   ...
					   <i>
						   <small><?php esc_html_e( 'Create timeslots for the days/dates selected above.', 'woocommerce-booking' ); ?>
						   <br><?php esc_html_e( 'Enter time in 24 hours format e.g. 14:00.', 'woocommerce-booking' ); ?>
						   <br><?php esc_html_e( 'Leave "To time" unchanged if you do not wish to create a fixed time duration slot.', 'woocommerce-booking' ); ?>
						   </small>
					   <i></td>
					   <td colspan="4" align="right" style="border-left: none;"><button type="button" id="bkap_remove_all_timeslots" class="button"><?php esc_html_e( 'Delete All Timeslots', 'woocommerce-booking' ); ?></button>&nbsp;<button type="button" class="button-primary bkap_add_new_date_time_range"><?php esc_html_e( 'Add New Timeslot', 'woocommerce-booking' ); ?></button></td>
					</tr>
				</table>
			...
			<div class="bkap_duration_date_timeslot_div" style="<?php echo $duration_time_table; ?>">
				...
				<table id="bkap_duration_date_timeslot_table">
					...
					<tr>
						...
						<td>
							<img class="help_tip" width="16" height="16"  data-tip="<?php esc_html_e( 'Set label for the duration field on the front end', 'woocommerce-booking' ); ?>" src="<?php echo esc_url( plugins_url( 'woocommerce/assets/images/help.png' ) ); ?>" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<img class="help_tip" width="16" height="16"  data-tip="<?php esc_html_e( 'Lengh of the time. Set value to 2 hours/minutes if the duration of your service is 2 hours/minutes. All the 2 hours/minutes durations will be created from mindnight till end of the day.', 'woocommerce-booking' ); ?>" src="<?php echo esc_url( plugins_url( 'woocommerce/assets/images/help.png' ) ); ?>" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<img class="help_tip" width="16" height="16"  data-tip="<?php esc_html_e( 'Set gap between two times. Set value to 2 hours/minutes if the gap between your service is 2 hours/minutes. All the duration will be created considering the gap time.', 'woocommerce-booking' ); ?>" src="<?php echo esc_url( plugins_url( 'woocommerce/assets/images/help.png' ) ); ?>" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<img class="help_tip" width="16" height="16"  data-tip="<?php esc_html_e( 'Minimum duration value a customer can select to book the service.', 'woocommerce-booking' ); ?>" src="<?php echo esc_url( plugins_url( 'woocommerce/assets/images/help.png' ) ); ?>" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<img class="help_tip" width="16" height="16"  data-tip="<?php esc_html_e( 'Maximum duration value a customer can select to book the service.', 'woocommerce-booking' ); ?>" src="<?php echo esc_url( plugins_url( 'woocommerce/assets/images/help.png' ) ); ?>" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<img class="help_tip" width="16" height="16"  data-tip="<?php esc_html_e( 'Set this field if you want to place a limit on maximum bookings on the duration. If you can manage up to 15 bookings in a duration, set this value to 15. Once 15 orders have been booked, then that duration will not be available for further bookings.', 'woocommerce-booking' ); ?>" src="<?php echo esc_url( plugins_url( 'woocommerce/assets/images/help.png' ) ); ?>" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<img class="help_tip" width="16" height="16"  data-tip="<?php esc_html_e( 'Price for the duration. ', 'woocommerce-booking' ); ?>" src="<?php echo esc_url( plugins_url( 'woocommerce/assets/images/help.png' ) ); ?>" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<img class="help_tip" width="16" height="16"  data-tip="<?php esc_html_e( 'Set this field if you want to start the duration from perticular time. If your day starts at 10:00am then you can set this value to 10:00. All the durations will be created from 10:00am till the value set in the Duration ends at option. If the Duration ends at option is blank then duration end time will be considered till end of the day.', 'woocommerce-booking' ); ?>" src="<?php echo esc_url( plugins_url( 'woocommerce/assets/images/help.png' ) ); ?>" />
						</td>
					</tr>
				</table>
			</div>
			...
			<div id="bkap_time_duration_availability" class="bkap_availability_range" style="<?php echo $manage_time_availability; ?>">
				...
				<div class="bkap_all_data_block_unavailable_section" style="display:flex;width:100%;margin-top:20px;">
					...
					<div>
						<img class="help_tip" width="16" height="16"  data-tip="<?php esc_html_e( 'Enabling this option will disable all the dates in the calendar. Usign this option with below table, you can enable desired dates for booking.', 'woocommerce-booking' ); ?>" src="<?php echo esc_url( plugins_url( 'woocommerce/assets/images/help.png' ) ); ?>" />
					</div>
				</div>
				<br>
			...
			<tr id="bkap_default_date_time_row" style="display: none;">
				<td width="20%" class="bkap_dateday_td">
					<select id="bkap_dateday_selector" multiple="multiple">
						<option name="all" value="all"><?php esc_html_e( 'All', 'woocommerce-booking' ); ?></option>
					   <?php
		...
		function setup_data( $product_id, $clean_booking_options, $clean_settings_data, $ranges_array, $clean_gcal_data, $clean_rental_data, $clean_fixed_block_data, $clean_price_range_data, $clean_resource_data = '', $clean_person_data = '' ) {
			...
			if ( '' !== $clean_booking_options && count( get_object_vars( $clean_booking_options ) ) > 0 ) {
				...
				$final_booking_options['_bkap_booking_type'] = ( null === $booking_type || '' === $booking_type || 'null' === $booking_type ) ? 'only_day' : $booking_type;
			...
			if ( isset( $ranges_array['blocks_enabled'] ) ) {
				...
				$block_ranges['_bkap_price_ranges'] = '';
			}
			...
			if ( isset( $ranges_array['ranges_enabled'] ) ) {
				$block_ranges['_bkap_fixed_blocks'] = '';
			...
			if ( $clean_resource_data != '' && count( get_object_vars( $clean_resource_data ) ) > 0 ) {
				...
				$final_resource_data['_bkap_product_resource_position']       = $clean_resource_data->_bkap_product_resource_position;
					...
					if ( $r_value != '' ) {
						...
						if ( isset( $explode_range[0] ) ) {
							...
							if ( is_numeric( $range_start ) ) { // it's a month number
								...
								if ( $range_start == '' ) {
									...
									$range_start = gmdate( 'j-n-Y', strtotime( $range_start ) );
								}
							}
						}
						if ( isset( $explode_range[1] ) ) {
							...
							if ( is_numeric( $range_end ) ) { // it's a month number
								...
								$month_start = gmdate( 'j-n-Y', strtotime( $month_to_use ) );

								$days      = gmdate( 't', strtotime( $month_start ) );
								$days     -= 1;
								$range_end = gmdate( 'j-n-Y', strtotime( "+$days days", strtotime( $month_start ) ) );

							} else { // it is a date
								if ( $range_end == '' ) {
									continue; // pick the next range
								} else {
									$range_end = gmdate( 'j-n-Y', strtotime( $range_end ) );
								}
							}
						}
		...
		function update_serialized_post_meta( $product_id, $booking_options, $settings_data, $block_ranges, $gcal_data, $rental_data, $resource_data, $person_data ) {
			...
			if ( isset( $resource_data ) && is_array( $resource_data ) && count( $resource_data ) > 0 ) {
				...
				if ( isset( $resource_data['_bkap_product_resource_position'] ) ) {
					$updated_settings['_bkap_product_resource_position'] = $resource_data['_bkap_product_resource_position'];
				} else {
					$updated_settings['_bkap_product_resource_position'] = 'before';
				}
		...
		static function bkap_delete_specific_range() {
			...
			$record_type = isset( $_POST['record_type'] ) ? sanitize_text_field( wp_unslash( $_POST['record_type'] ) ) : '';
			$start       = isset( $_POST['start'] ) ? sanitize_text_field( wp_unslash( $_POST['start'] ) ) : '';
			$end         = isset( $_POST['start'] ) ? sanitize_text_field( wp_unslash( $_POST['start'] ) ) : '';
		...
		static function bkap_update_date_time_slot() {
			...
			$booking_weekday = isset( $_POST['booking_weekday']['0'] ) ? sanitize_text_field( wp_unslash( $_POST['booking_weekday']['0'] ) ) : '';
			...
			$prev_time_slot = array(
				...
				'lockout_time'      => isset( $_POST['max_lockout'] ) ? (int) $_POST['max_lockout'] : '',
				'global_time_check' => isset( $_POST['global_time_check'] ) ? sanitize_text_field( wp_unslash( $_POST['global_time_check'] ) ) : '',
				'product_price'     => isset( $_POST['product_price'] ) ? floatval( $_POST['product_price'] ) : '',
				'additional_note'   => isset( $_POST['additional_note'] ) ? sanitize_text_field( wp_unslash( $_POST['additional_note'] ) ) : '',
			);

			$cur_time_slot = array(
				'from_time'         => isset( $_POST['cur_from_time'] ) ? sanitize_text_field( wp_unslash( $_POST['cur_from_time'] ) ) : '',
				'to_time'           => isset( $_POST['cur_to_time'] ) ? sanitize_text_field( wp_unslash( $_POST['cur_to_time'] ) ) : '',
				'lockout_time'      => isset( $_POST['cur_max_lockout'] ) ? (int) $_POST['cur_max_lockout'] : '',
				'global_time_check' => isset( $_POST['cur_global_time_check'] ) ? sanitize_text_field( wp_unslash( $_POST['cur_global_time_check'] ) ) : '',
				'product_price'     => isset( $_POST['cur_product_price'] ) ? floatval( $_POST['cur_product_price'] ) : '',
				'additional_note'   => isset( $_POST['cur_additional_note'] ) ? sanitize_text_field( wp_unslash( $_POST['cur_additional_note'] ) ) : '',
			);
			// phpcs:enable WordPress.Security.NonceVerification
		...
		public static function bkap_delete_date_time() {
			// phpcs:disable WordPress.Security.NonceVerification
			$product_id = isset( $_POST['product_id'] ) ? sanitize_text_field( wp_unslash( $_POST['product_id'] ) ) : '';
		 ...
		 * @since 4.19.2
		 */
		public static function bkap_delete_all_date_time() {
		 ...
		 * @since 4.0.0
		 */
		public function delete_serialized_time_settings( $product_id, $day_value, $from_time, $to_time ) {
		 ...
		 * @since 4.0.0
		 */
		public function bkap_product_duplicate( $new_id, $post ) {
			global $wpdb;
