 ...
 * @package     BKAP/Admin/Views/Addons/RentalSystem
 * @since       5.19.0
 */

?>
<template id="rental-system-tab">
	<section>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="bkap-page-head phw-btn">
						<div class="col-left">
                            <h1><?php esc_attr_e( 'Rental System', 'woocommerce-booking' ); // phpcs:ignore ?></h1>
							</p>
						</div>
								...
								<div id="collapseOne" class="panel-collapse collapse show">
									<div class="panel-body">
										<div class="tbl-mod-1">
											<div class="tm1-row">
												<div class="col-left">
													<label><?php esc_attr_e( 'Sale and Rent On Product Page', 'woocommerce-booking' ); ?></label>
												</div>
												<div class="col-right">
													<div class="rc-flx-wrap flx-aln-center">
														<img class="tt-info"
															...
															title="<?php esc_attr_e( 'Appearance of Sale and Rent Buttons on WooCommerce Product Page.', 'woocommerce-booking' ); ?>">
														<label class="el-switch el-switch-green">
															<input type="checkbox"
																v-model="data.settings.booking_global_product_page"
										...
										<div class="tbl-mod-1">
											<div class="tm1-row">
												<div class="col-left">
													<label><?php esc_attr_e( 'Sale Button Text', 'woocommerce-booking' ); ?></label>
												</div>
												<div class="col-right">
													<div class="rc-flx-wrap flx-aln-center">
														<img class="tt-info"
															src="<?php echo esc_url( BKAP_IMAGE_URL . 'icon-info.svg' ); ?>"
															alt="Tooltip" data-toggle="tooltip" data-placement="top"
															title="<?php esc_attr_e( 'Set text for Sale button on WooCommerce Product Page.', 'woocommerce-booking' ); ?>">
															<input type="text"
																v-model="data.settings.bkap_sale">
										...
										<div class="tbl-mod-1">
											<div class="tm1-row">
												<div class="col-left">
													<label><?php esc_attr_e( 'Rent Button Text', 'woocommerce-booking' ); ?></label>
												</div>
												<div class="col-right">
													<div class="rc-flx-wrap flx-aln-center">
														<img class="tt-info"
															src="<?php echo esc_url( BKAP_IMAGE_URL . 'icon-info.svg' ); ?>"
															alt="Tooltip" data-toggle="tooltip" data-placement="top"
															title="<?php esc_attr_e( 'Set text for Rent button on WooCommerce Product Page.', 'woocommerce-booking' ); ?>">
														<input type="text"
																v-model="data.settings.bkap_rent">
