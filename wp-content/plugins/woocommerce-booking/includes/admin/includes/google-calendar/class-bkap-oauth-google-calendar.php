 ...
 *
 * OAuth Class for Google Calendar API
 *
...
class BKAP_OAuth_Google_Calendar {
	 ...
	 * Product or Global.
	 *
	 * @var bool $is_product Product Or Global Level.
	 */
	public $is_product;
	 ...
	 * GCal Object.
	 *
	 * @var object $gcal GCal Object.
	 */
	public $gcal;

	/**
	 * Google Service Calendar Data.
	 *
	 * @var obj $service Google_Service_Calendar object.
	 */
	public $service;
	...
	public function __construct( $product_id = 0, $user_id = 1 ) {
		...
		$this->gcal       = new BKAP_Google_Calendar(); // For using log function of BKAP_Gcal class.
	...
	public function bkap_get_refresh_token() {
		return $this->is_product ? get_post_meta( $this->product_id, '_bkap_gcal_refresh_token', true ) : get_option( 'bkap_gcal_refresh_token' );
	}
	...
	public function get_client() {
		...
		$oauth_settings = $this->is_product ? get_post_meta( $this->product_id, '_bkap_calendar_oauth_integration', true ) : get_option( 'bkap_calendar_oauth_integration', null );
