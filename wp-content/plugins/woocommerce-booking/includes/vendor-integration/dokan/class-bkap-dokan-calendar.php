...
if ( ! class_exists( 'bkap_dokan_calendar_class' ) ) {
	...
	class bkap_dokan_calendar_class {
		...
		public function bkap_dokan_include_calendar_styles() {
			...
			BKAP_Scripts::bkap_load_products_css( $this->plugin_version );
			BKAP_Scripts::bkap_load_calendar_styles( $this->plugin_version );
		}
		...
		public function bkap_dokan_include_calendar_scripts() {
			...
			BKAP_Scripts::bkap_load_calendar_scripts( $this->plugin_version, get_current_user_id() );
		}
	}
}
