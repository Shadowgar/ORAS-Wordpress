...
if ( ! class_exists( 'bkap_dokan_products_class' ) ) {
	...
	class bkap_dokan_products_class {
		...
		public function bkap_add_booking_meta( $post ) {
			...
			BKAP_Scripts::bkap_load_products_css( $plugin_version_number );
			BKAP_Scripts::bkap_load_bkap_tab_css( $plugin_version_number );
			BKAP_Scripts::bkap_load_dokan_css( $plugin_version_number );
			?>
			...
			<div class="dokan-bkap-settings dokan-edit-row" id="product-bkap-bookings">
				<div class="dokan-section-heading" data-togglehandler="dokan_bkap_settings">
					<h2>
						...
						<?php esc_html_e( 'Booking', 'woocommerce-booking' ); ?>
					</h2>
					<p><?php esc_html_e( 'Manage Booking Settings for this product.', 'woocommerce-booking' ); ?></p>
			...
			BKAP_Scripts::bkap_common_admin_scripts_js( $plugin_version_number );
			BKAP_Scripts::bkap_load_product_scripts_js( $plugin_version_number, $ajax_url );
			BKAP_Scripts::bkap_load_dokan_product_scripts_js( $plugin_version_number, $ajax_url );
			BKAP_Scripts::bkap_load_resource_scripts_js( $plugin_version_number, $ajax_url );
			wp_register_script( 'jquery-tiptip', BKAP_Files::rewrite_asset_url( '/assets/js/jquery.tipTip.minified.js', BKAP_FILE, false, false ), array( 'jquery' ), $plugin_version_number, false );
