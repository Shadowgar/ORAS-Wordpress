...
?>
<div class="mec-wrap mec-single-liquid-wrap mec-liquid-wrap <?php echo $has_thumbnail ? 'mec-liquid-has-thumbnail' : ''; ?> <?php echo $event_colorskin; ?> mec-modal-wrap clearfix <?php echo $this->html_class; ?>" id="mec_skin_<?php echo $this->uniqueid; ?>"  style="padding: 20px;">
