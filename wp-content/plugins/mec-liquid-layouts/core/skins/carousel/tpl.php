...
$navigation =$this->skin_options['navigation']==1? true : false;
...
jQuery(document).ready(function()
{
    jQuery("#mec_skin_'.esc_js($this->id).'").mecCarouselView(
    {
        ...
        navText: ' . wp_json_encode(['<i class="mec-fa-angle-left"></i>', '<i class="mec-fa-angle-right"></i>']) . ',
    });
});
</script>';
...
<div class="mec-wrap mec-liquid-wrap mec-skin-carousel-container<?php echo esc_attr($this->html_class . ' ' . $set_dark); ?>" id="mec_skin_<?php echo esc_attr($this->id); ?>">
    <?php if($this->found): ?>
