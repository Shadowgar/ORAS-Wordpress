<?php
namespace MEC_Liquid\Core\checkLicense;
 ...
 * @since       1.0.0
 */
class LiquidViewAddonUpdateActivation
{
     ...
     * @access  public
     */
    public $option_string = MECLIQUIDOPTIONS;
     ...
     * @access  public
     */
    public $license_status_string = MECLIQUIDTEXTDOMAIN . 'license_status';
     ...
     * @access  public
     */
    public $reActivation_string = MECLIQUIDTEXTDOMAIN . 'reActivationOption';
     ...
     * @access  public
     */
    public $text_domain_string = MECLIQUIDTEXTDOMAIN;
     ...
     * @access  public
     */
    public $name_string = MECLIQUIDNAME;
     ...
     * @access  public
     */
    public $slug_string = MECLIQUIDSLUG;
     ...
     * @access  public
     */
    public $main_file_path = MECLIQUIDMAINFILEPATH;
    ...
    public static function setHooks($This){
        ...
        add_action(	'wp_ajax_activate_Addons_Integration_liquid', array($This, 'activate_Addons_Integration_liquid'));
    }
            ...
            if (jQuery("#'.$this->text_domain_string.'").length > 0)
            {
                jQuery("#'.$this->text_domain_string.' input[type=submit]").on("click", function(e){
                    ...
                    jQuery.ajax({
                        ...
                        type: "POST",
                        data: {
                            action: "activate_Addons_Integration_liquid",
    ...
    public function activate_Addons_Integration_liquid() {
    ...
    public function load_auto_update() {
        ...
        require_once MECLIQUIDABSPATH.'/core/checkLicense/puc/plugin-update-checker.php';
